...
Revision ID: 5dff82c46956
Revises: 
Create Date: 2024-09-05 11:06:37.345895
...
def upgrade():
    ...
    op.create_table('verification_email',
    sa.Column('email', sa.String(length=200), nullable=False),
    sa.Column('verified', sa.Integer(), nullable=True),
    sa.Column('verification_test', sa.Integer(), nullable=True),
    sa.Column('date_time', sa.DateTime(), nullable=True),
    sa.Column('inputter', sa.String(length=150), nullable=False),
    ...
    sa.Column('date_time', sa.DateTime(), nullable=True),
    sa.Column('inputter', sa.String(length=150), nullable=False),
    sa.ForeignKeyConstraint(['music'], ['music.mic'], ),
...
def downgrade():
    ...
    op.drop_table('verification_email')
    op.drop_table('users')
